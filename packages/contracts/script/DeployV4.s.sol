...
///         MockUSDT, two licensed-firm arbitrator adapters (primary + fallback), EscrowCoreV4.
/// @dev    Env:
...
///           MINT_TO              optional address to receive 1,000,000 test USDT
...
contract DeployV4 is Script {
    function run() external {
        ...
        if (mintTo != address(0)) usdt.mint(mintTo, 1_000_000e6);
        ...
        vm.serializeAddress(key, "usdt", address(usdt));
